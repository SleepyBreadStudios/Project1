...
{
    private readonly string[] itemPrefabs = { "coal"};
    [SerializeField]
    ...
    public void SpawnStart()
    {
        ...
        {
            string toLoad = "Prefabs/Items/" + itemPrefabs[Random.Range(0, 1)];
    ...
    public bool SpawnObjects(Vector3 pos, ulong networkId, GameObject gameObj)
    {
        ...
        string toLoad = "Prefabs/Items/" + itemPrefabs[Random.Range(0, 10)];
